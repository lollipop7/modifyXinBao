...
layui.use(['form', "jquery", "element", "layer", "nicescroll", "utilset"], function () {
    ...
    $('.btn-contactus, #openForm1, #openForm2, #openForm3, #openForm4').click(function () {
        ...
        form.verify({
            corpname: function corpname(value, item) {
                //value：表单的值、item：表单的DOM对象
                if (!new RegExp('^[a-zA-Z0-9_\u4E00-\u9FA5\\s\xB7]+$').test(value)) {
                    return '用户名不能有特殊字符';
                }
            ...
            linkman: function linkman(value, item) {
                //value：表单的值、item：表单的DOM对象
                if (!new RegExp('^[a-zA-Z0-9_\u4E00-\u9FA5\\s\xB7]+$').test(value)) {
                    return '用户名不能有特殊字符';
                }
            ...
            telephone: function (_telephone) {
                function telephone(_x, _x2) {
                    return _telephone.apply(this, arguments);
                }

                telephone.toString = function () {
    ...
    form.verify({
        ...
        telephone: function (_telephone2) {
            function telephone(_x3, _x4) {
                return _telephone2.apply(this, arguments);
            }

            telephone.toString = function () {
                return _telephone2.toString();
            };
